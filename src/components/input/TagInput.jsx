...
const TagInput = ({ tags, setTags }) => {
    ...
    return (
        <div>
            ...
            {tags?.length > 0 && (
                <div className='flex items-center ga[-2 flex-wrap mt-2'>
                    {tags?.map((tag, index) => (
            ...
            <div className='flex items-center gap-4 mt-3'>
                ...
                />
                <button className=' w-8 h-8 flex items-center justify-center rounded border border-e-blue-700  hover:bg-blue-700'
                    onClick={() => {
                        addNewTag()
                    }}>
